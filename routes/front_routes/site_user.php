...
/* * ******** UserController ************ */
Route::post('user-profile', 'UserController@userProfileUpdate')->name('user.profile');
...
Route::post('store-front-profile-education-default/{id}', 'UserController@submitDefaultProfileEducationForm')->name('store.front.profile.education.default');
...
Route::post('update-front-profile-language-type/{language_id}', 'UserController@getLanguageType')->name('update.front.profile.language.type');

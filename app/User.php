...

{
...

    {
        ...
        return \ImgUploader::print_image("user_images/$cover_image", $width, $height, '/admin_assets/bhalojob3.png', $this->name);
    }
    ...
    public function country_id_bd()

    {

        return $this->belongsTo('App\Country', 'country_id_bd', 'country_id');
    }

    public function getCountryIdBd($field = '')

    {

        $country_id_bd = $this->country_id_bd()->lang()->first();

        if (null === $country_id_bd) {

            $country_id_bd = $this->country_id_bd()->first();
        }
        ...
        if (null !== $country_id_bd) {
            ...
            if (!empty($field))
                ...
                return $country_id_bd->$field;

            else

                return $country_id_bd;
        }
    }

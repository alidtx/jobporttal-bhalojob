...
class DataArrayHelper
{
    ...
    public static function subCategoryArray($category_id)
    {
        $array = jobSubCategory::select('job_sub_categories.sub_name', 'job_sub_categories.id','job_sub_categories.job_user_type')->where('job_sub_categories.category_id', $category_id)->pluck('job_sub_categories.sub_name', 'job_sub_categories.id','job_sub_categories.job_user_type')->toArray();


        return $array;
    }

    public static function industryArray($sub_category_id){
        ...
        $subcategories = jobIndustry::select('job_industries.*',  'industries.id as industries_id', 'industries.industry')
            ...
            ->where('job_industries.sub_id',$sub_category_id)
            ->pluck('industries.industry', 'industries.id')->toArray();


        //$array = Industry::select('industries.industry', 'industries.id')->where('industries.id', $industry_id)->pluck('industries.industry', 'industries.id')->toArray();
    ...
    {
        $array = jobCategory::select('job_categories.name', 'job_categories.id')->pluck('job_categories.name', 'job_categories.id')->toArray();
        return $array;
    }

...

{
...

    {
        ...
        if (!empty($this->facebook))
            ...
            $html .= '<a href="' . $this->facebook . '" target="_blank"> <i class="fa-brands fa-square-facebook"></i>  </a>';



        if (!empty($this->twitter))

            $html .= '<a href="' . $this->twitter . '" target="_blank"> <i class="fa-brands fa-twitter"></i> </a>';



        if (!empty($this->linkedin))

            $html .= '<a href="' . $this->linkedin . '" target="_blank"> <i class="fa-brands fa-linkedin"></i> </a>';



        if (!empty($this->google_plus))

            $html .= '<a href="' . $this->google_plus . '" target="_blank"> <i class="fa-brands fa-square-google-plus"></i> </a>';



        if (!empty($this->pinterest))

            $html .= '<a href="' . $this->pinterest . '" target="_blank"><i class="fa-brands fa-pinterest"></i></a>';

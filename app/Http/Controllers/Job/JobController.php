...
class JobController extends Controller
{
    ...
    {    //echo 'hii'; exit();
       ...
       //  dd($this->countries);
        ...
        if(!Auth::check())
        {
            flash(__('please registration or login first '))->success();
        ...
        $category = $request->query('category',array());
        $sub_category_id = $request->query('sub_category_id',array());
       ...
       // dd($categoryIdsArray);
        ...
        return view('job.list')
                        ...
                        ->with('categoryIdsArray', $categoryIdsArray)
                        ...
                        ->with('sub_category_id', $sub_category_id)
                        ->with('industry_ids', $industry_ids)
                        ->with('city_ids', $city_ids)
                        ->with('seo', $seo);
    }

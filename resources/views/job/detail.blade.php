        ...
        <div class="job-header">
            ...
            <div class="jobButtons">
                {{-- <a href="{{route('email.to.friend', $job->slug)}}" class="btn"><i class="fas fa-envelope" aria-hidden="true"></i> {{__('Email to Friend')}}</a> --}}
                   ...
                   <a href="{{route('remove.from.favourite', $job->slug)}}" class="btn"><i class="fas fa-floppy-o" aria-hidden="true"></i> {{__('Remove from Favourate')}} </a>

                   @else 

                  <a href="{{route('add.to.favourite', $job->slug)}}" class="btn"><i class="fas fa-floppy-o" aria-hidden="true"></i> {{__('Add to Favourite')}}</a>

...
<body>
    ...
    <script type="text/JavaScript">
      ...
      $(document).ready(function(){
            $('.login_alart').click(function(){
                Swal.fire({
                    title: ' エグゼクティブ・スペシャリストの転職はジェイエイシーリクルートメント ※ご登録のメールアドレス宛に、 求人紹介メール等を お送りしますので、 スのご登録を推奨しております。',
                    showDenyButton: true,
                    confirmButtonText: "はい",
                    denyButtonText: `いいえ`,
                    title: ' エグゼクティブ・スペシャリストの転職はジェイエイシーリクルートメント ',
                }).then((result) => {
        ...
        // $(document).ready(function(){
        //     $('.login-user-images ').hover(function() {
        ...
        $(document).ready(function(){
            $('#ul#profileEdit a').click(function() {
    ...
    <script>
        ...
        const school = new Swiper('.school_slider', {
            loop: true,
            slidesPerView: 6,
            spaceBetween: 25,
            // Navigation arrows
        ...
        const college = new Swiper('.college_slider', {
            loop: true,
            slidesPerView: 6,
            spaceBetween: 25,
            // Navigation arrows
